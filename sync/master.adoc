Unresolved directive in data-sync.adoc - include::https://raw.githubusercontent.com/aerogear/mobile-docs/master/modules/ROOT/pages/_partials/attributes.adoc[]
